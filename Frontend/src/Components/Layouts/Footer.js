...
<>
  <div className="footer">
    <div className="footer_agile_inner_info_w3l">
        ...
        <div className="sign-grds">
          <div className="col-md-4 sign-gd">
            ...
            <ul>
              ...
              <li>
                <a href="typography.html">Short Codes</a>
              </li>
              <li>
            ...
            <div className="w3-address">
              ...
              <div className="w3-address-grid">
                ...
                <div className="w3-address-right">
                  ...
                  <p>
                    Email :
                    <a href="mailto:example@email.com"> kaurnavprit5@gmail.com</a>
                  </p>
                </div>
                <div className="clearfix"> </div>
              </div>
      ...
      <p className="copy-right">
        © 2017 cosmoCollection . All rights reserved | Design by{" "}
  ...
  {/* //login */}
  <a href="#home" className="scroll" id="toTop" style={{ display: "block" }}>
    {" "}
