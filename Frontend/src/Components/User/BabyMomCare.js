...
getData()
    ...
    return(
     ...
     <div className="col-md-3 product-men">
       ...
       <div className="men-pro-item simpleCart_shelfItem">
         <div className="men-thumb-item">
           <img src="/assets/images/b1.webp" alt="" className="pro-image-front"  style={{height:"300px", width:"300px"}} />
           <img src="/assets/images/b1.webp" alt="" className="pro-image-back"  style={{height:"300px", width:"300px"}} />
         ...
         <div className="item-info-product ">
           <h4>
             <a href="single.html">Baby Care</a>
           </h4>
     ...
     <div className="col-md-3 product-men">
       <div className="men-pro-item simpleCart_shelfItem">
         <div className="men-thumb-item">
           <img src="/assets/images/b2.webp" alt="" className="pro-image-front"  style={{height:"300px", width:"300px"}} />
           <img src="/assets/images/b2.webp" alt="" className="pro-image-back"  style={{height:"300px", width:"300px"}} />
           <div className="men-cart-pro">
             <div className="inner-men-cart-pro">
