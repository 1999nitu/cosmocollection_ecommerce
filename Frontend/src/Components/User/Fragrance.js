  ...
  {/* //banner */}
            ...
            <div className="men-pro-item simpleCart_shelfItem">
              <div className="men-thumb-item">
                <img src="/assets/images/f-1.jpg" alt="" className="pro-image-front"  style={{height:"300px", width:"300px"}} />
                <img src="/assets/images/f-1.jpg" alt="" className="pro-image-back"  style={{height:"300px", width:"300px"}} />
              ...
              <div className="item-info-product ">
                <h4>
                  <a href="single.html">Fragrance for Women</a>
                </h4>
          ...
          <div className="col-md-3 product-men">
            <div className="men-pro-item simpleCart_shelfItem">
              <div className="men-thumb-item">
                <img src="/assets/images/f-2.webp" alt="" className="pro-image-front"  style={{height:"300px", width:"300px"}} />
                <img src="/assets/images/f-2.webp" alt="" className="pro-image-back"  style={{height:"300px", width:"300px"}} />
                <div className="men-cart-pro">
                  <div className="inner-men-cart-pro">
              ...
              <div className="item-info-product ">
                <h4>
                  <a href="single.html">Perfume for Men</a>
                </h4>
                <div className="info-product-price">
          ...
          <div className="col-md-3 product-men">
            <div className="men-pro-item simpleCart_shelfItem">
              ...
              <div className="item-info-product ">
                <h4>
                  <a href="single.html">Fragrance Kits</a>
                </h4>
                <div className="info-product-price">
          ...
          <div className="col-md-3 product-men">
            <div className="men-pro-item simpleCart_shelfItem">
              <div className="men-thumb-item">
                <img src="/assets/images/f-4.webp" alt="" className="pro-image-front" style={{height:"300px", width:"300px"}} />
                <img src="/assets/images/f-4.webp" alt="" className="pro-image-back"  style={{height:"300px", width:"300px"}} />
                <div className="men-cart-pro">
                  <div className="inner-men-cart-pro">
                    <a href="single.html" className="link-product-add-cart">
                      Quick View
