...
export default function HairCair(){
    ...
    return(
     ...
     <div className="col-md-3 product-men">
       <div className="men-pro-item simpleCart_shelfItem">
         ...
         <div className="item-info-product ">
           <h4>
             <a href="single.html">Hair Styling</a>
           </h4>
           <div className="info-product-price">
     ...
     <div className="col-md-3 product-men">
       <div className="men-pro-item simpleCart_shelfItem">
         <div className="men-thumb-item">
           <img src="/assets/images/h3.webp" alt="" className="pro-image-front" style={{height:"300px", width:"300px"}} />
           <img src="/assets/images/h3.webp" alt="" className="pro-image-back"  style={{height:"300px", width:"300px"}} />
           <div className="men-cart-pro">
             <div className="inner-men-cart-pro">
               <a href="single.html" className="link-product-add-cart">
                 Quick View
         ...
         <div className="item-info-product ">
           <h4>
             <a href="single.html">Shampoo & Conditioners</a>
           </h4>
           <div className="info-product-price">
     ...
     <div className="col-md-3 product-men">
       <div className="men-pro-item simpleCart_shelfItem">
         <div className="men-thumb-item">
           <img src="/assets/images/h4.webp" alt="" className="pro-image-front" style={{height:"300px", width:"300px"}} />
           <img src="/assets/images/h4.webp" alt="" className="pro-image-back"  style={{height:"300px", width:"300px"}} />
           <div className="men-cart-pro">
             <div className="inner-men-cart-pro">
               <a href="single.html" className="link-product-add-cart">
                 Quick View
         ...
         <div className="item-info-product ">
           <h4>
             <a href="single.html">Hair Styling Tools </a>
           </h4>
           <div className="info-product-price">
             <span className="item_price">$320.99</span>
             <del>$489.71</del>
