        ...
        <>
          ...
          (el,index)=>(
            <Fragment>
              ...
              <p>  <img src={"http://localhost:4000/" +el.subcategoryImage} style={{height:"100px", width:"100px"}}/>
             </p> */}
  ...
  {/* //banner */}
            ...
            <div className="men-pro-item simpleCart_shelfItem">
              <div className="men-thumb-item">
                <img src="/assets/images/lipbalm.webp" alt="" className="pro-image-front"  style={{height:"300px", width:"300px"}} />
                <img src="/assets/images/lipbalm.webp" alt="" className="pro-image-back"  style={{height:"300px", width:"300px"}} />
          ...
          <div className="col-md-3 product-men">
            <div className="men-pro-item simpleCart_shelfItem">
              <div className="men-thumb-item">
                <img src="/assets/images/pro_3.jpg" alt="" className="pro-image-front" style={{height:"300px", width:"300px"}} />
                <img src="/assets/images/pro_3.jpg" alt="" className="pro-image-back"  style={{height:"300px", width:"300px"}} />
                <div className="men-cart-pro">
                  <div className="inner-men-cart-pro">
                    <a href="single.html" className="link-product-add-cart">
                      Quick View
              ...
              <div className="item-info-product ">
                <h4>
                  <a href="single.html">Cleansers</a>
                </h4>
                <div className="info-product-price">
          ...
          <div className="col-md-3 product-men">
            <div className="men-pro-item simpleCart_shelfItem">
              <div className="men-thumb-item">
                <img src="/assets/images/pro_1.jpeg" alt="" className="pro-image-front"  style={{height:"300px", width:"300px"}} />
                <img src="/assets/images/pro_1.jpeg" alt="" className="pro-image-back"  style={{height:"300px", width:"300px"}} />
                <div className="men-cart-pro">
                  <div className="inner-men-cart-pro">
                    <a href="single.html" className="link-product-add-cart">
                      Quick View
              ...
              <div className="item-info-product ">
                <h4>
                  <a href="single.html">Face Wash</a>
                </h4>
                <div className="info-product-price">
          ...
          <div className="col-md-3 product-men">
            <div className="men-pro-item simpleCart_shelfItem">
              <div className="men-thumb-item">
                <img src="/assets/images/skin5.webp" alt="" className="pro-image-front"  style={{height:"300px", width:"300px"}} />
                <img src="/assets/images/skin5.webp" alt="" className="pro-image-back"  style={{height:"300px", width:"300px"}} />
                <div className="men-cart-pro">
                  <div className="inner-men-cart-pro">
                    <a href="single.html" className="link-product-add-cart">
                      Quick View
              ...
              <div className="item-info-product ">
                <h4>
                  <a href="single.html">Sunscreens</a>
                </h4>
                <div className="info-product-price">
          ...
          <div className="col-md-3 product-men">
            <div className="men-pro-item simpleCart_shelfItem">
              <div className="men-thumb-item">
                <img src="/assets/images/makeup-1.jpg" alt="" className="pro-image-front" />
                <img src="/assets/images/makeup-1.jpg" alt="" className="pro-image-back" />
                <div className="men-cart-pro">
                  <div className="inner-men-cart-pro">
                    <a href="single.html" className="link-product-add-cart">
                      Quick View
          ...
          <div className="col-md-3 product-men">
            <div className="men-pro-item simpleCart_shelfItem">
              <div className="men-thumb-item">
                <img src="/assets/images/skin3.webp" alt="" className="pro-image-front"  style={{height:"300px", width:"300px"}} />
                <img src="/assets/images/skin3.webp" alt="" className="pro-image-back"  style={{height:"300px", width:"300px"}} />
                <div className="men-cart-pro">
                  <div className="inner-men-cart-pro">
                    <a href="single.html" className="link-product-add-cart">
                      Quick View
              ...
              <div className="item-info-product ">
                <h4>
                  <a href="single.html">Moisturizers</a>
                </h4>
                <div className="info-product-price">
                  <span className="item_price">$100.99</span>
                  <del>$159.71</del>
